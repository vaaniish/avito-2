...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Мы работаем с несколькими службами доставки: Почта России, пункты выдачи и курьерские службы. Стоимость доставки рассчитывается автоматически при оформлении заказа. Оплата возможна картой онлайн, наличными курьеру или при получении в пункте выдачи. Доставка по Москве — 1-2 дня, по России — 3-7 дней.'
  },
  {
