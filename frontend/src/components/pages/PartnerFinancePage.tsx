...
export function PartnerFinancePage() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `partner_finance_${new Date().toISOString().slice(0, 10)}.csv`;
    ...
    <div className="space-y-4 md:space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="dashboard-subtitle">Заработано, комиссии, выплаты, платежи и динамика заказов</p>
        </div>
        ...
        <section className="dashboard-card finance-panel">
          <div className="finance-panel__header">
            <div>
              ...
              <p>Деньги по сделкам без рейтинга единичных объявлений</p>
            </div>
          </div>
