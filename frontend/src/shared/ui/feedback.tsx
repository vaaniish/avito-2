...
export function ToastViewport({ notices, onClose, onCloseAll }: ToastViewportProps) {
  useEffect(() => {
    ...
    const handleDocumentClick = (event: MouseEvent) => {
      ...
      if (target.closest('[data-modal-kind="confirm-dialog"]')) {
        return;
      }
      onCloseAll();
    };
