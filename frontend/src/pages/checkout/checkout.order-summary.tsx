    ...
    <div className="h-fit lg:sticky lg:top-32">
      <div className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8">
        ...
        <div className="space-y-3">
          ...
          {!canSubmitOrder ? (
            <div className="rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800 md:text-sm">
              Администратор может проверить оформление заказа, но не может оплачивать его со своего аккаунта.
            </div>
          ) : null}
          {!hasActivePayment && (
