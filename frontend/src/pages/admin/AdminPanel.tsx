...
const TransactionsPage = lazy(() =>
  import("./transactions/TransactionsPage").then((module) => ({
    default: module.TransactionsPage,
  })),
);
const ComplaintsPage = lazy(() =>
  import("./complaints/ComplaintsPage").then((module) => ({
    default: module.ComplaintsPage,
  })),
);
const SellersPage = lazy(() =>
  import("./sellers/SellersPage").then((module) => ({ default: module.SellersPage })),
);
const ListingsPage = lazy(() =>
  import("./listings/ListingsPage").then((module) => ({ default: module.ListingsPage })),
);
const UsersPage = lazy(() =>
  import("./users/UsersPage").then((module) => ({ default: module.UsersPage })),
);
const CommissionsPage = lazy(() =>
  import("./commissions/CommissionsPage").then((module) => ({
    default: module.CommissionsPage,
  })),
);
const AuditLogsPage = lazy(() =>
  import("./audit-logs/AuditLogsPage").then((module) => ({
    default: module.AuditLogsPage,
  })),
);
const CatalogSuggestionsPage = lazy(() =>
  import("./catalog-suggestions/CatalogSuggestionsPage").then((module) => ({
