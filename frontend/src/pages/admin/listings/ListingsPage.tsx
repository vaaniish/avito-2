...
import { ScoreExplanation, type ScoreExplanationRow } from "../../../shared/ui/ScoreExplanation";
    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="space-y-3">
        {filteredListings.map((listing) => {
          ...
          const isDecisionLocked = listing.status === "approved" || listing.status === "rejected";
          return (
