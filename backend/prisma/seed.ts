...
async function main(): Promise<void> {
  ...
  const listings = [
    ...
    [
      ...
      "Москва",
      "PRODUCT",
      "Противоударный чехол для Galaxy S24",
      1900,
      null,
      "NEW",
      "ACTIVE",
    ...
    [
      ...
      "Екатеринбург",
      "PRODUCT",
      "Сетевое зарядное устройство USB-C 65W",
      4200,
      null,
      "NEW",
      "ACTIVE",
    ...
    [
      ...
      "Краснодар",
      "PRODUCT",
      "Зарядное устройство для ноутбука 90W",
      5600,
      5100,
      "NEW",
      "ACTIVE",
