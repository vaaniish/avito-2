...
async function main(): Promise<void> {
  ...
  const userMap = new Map(
    (await prisma.appUser.findMany({ select: { id: true, public_id: true } })).map((u) => [
      u.public_id,
      u.id,
    ]),
  );
  ...
  const tierMap = new Map(
    (
      await prisma.commissionTier.findMany({ select: { id: true, public_id: true } })
  ...
  const categoryMap = new Map(
    (
      await prisma.catalogCategory.findMany({ select: { id: true, public_id: true } })
  ...
  const subcategoryMap = new Map(
    (
      await prisma.catalogSubcategory.findMany({ select: { id: true, public_id: true } })
  ...
  const itemMap = new Map(
    (await prisma.catalogItem.findMany({ select: { id: true, public_id: true } })).map((i) => [
      i.public_id,
      i.id,
    ]),
  );
  ...
  for (const o of orders as unknown as any[]) {
    const itemsTotal = o[9].reduce((acc: number, item: any) => acc + item[1] * item[2], 0);
  ...
  await prisma.complaint.createMany({
    data: [
      ["CMP-001", "APPROVED", "fraud", "LST-026", "SLR-004", "BUY-002", "Категория: Нарушение правил или обман\nПричина: Кажется, это мошенники\nКомментарий: Продавец уводит общение в сторонний канал и уклоняется от проверки товара.", null, 4, "ADM-001", "Жалоба подтверждена, объявление ограничено"],
      ["CMP-002", "PENDING", "suspicious_listing", "LST-002", "SLR-001", "BUY-003", "Категория: Информация в объявлении\nПричина: Неправдивые фото или описание\nКомментарий: Характеристики в карточке не совпадают с ответом продавца.", null, null, null, null],
      ["CMP-003", "NEW", "other", "LST-005", "SLR-004", "BUY-001", "Категория: Общение с продавцом\nПричина: Невозможно связаться\nКомментарий: В разделе вопросов по объявлению нет ответа длительное время.", null, null, null, null],
      ["CMP-004", "REJECTED", "suspicious_listing", "LST-001", "SLR-001", "BUY-004", "Категория: Информация в объявлении\nПричина: Неверная цена\nКомментарий: После проверки цена в карточке и характеристиках совпала.", null, 8, "ADM-001", "Жалоба отклонена после проверки"],
      ["CMP-005", "APPROVED", "other", "LST-008", "SLR-004", "BUY-004", "Категория: Общение с продавцом\nПричина: Хамство, грубость\nКомментарий: Есть некорректные ответы в разделе вопросов.", null, 2, "ADM-001", "Подтверждено нарушение правил общения"],
      ["CMP-006", "PENDING", "suspicious_listing", "LST-009", "SLR-003", "BUY-002", "Категория: Информация в объявлении\nПричина: Неправдивые фото или описание\nКомментарий: На фото и в описании указано иное состояние.", null, null, null, null],
      ["CMP-007", "NEW", "suspicious_listing", "LST-011", "SLR-001", "BUY-001", "Категория: Информация в объявлении\nПричина: Неправдивые фото или описание\nКомментарий: Реальное состояние хуже, чем заявлено.", null, null, null, null],
      ["CMP-008", "PENDING", "suspicious_listing", "LST-012", "SLR-002", "BUY-004", "Категория: Информация в объявлении\nПричина: Неверная цена\nКомментарий: Цена в заголовке и параметрах объявления отличается.", null, null, null, null],
      ["CMP-009", "APPROVED", "fraud", "LST-014", "SLR-004", "BUY-002", "Категория: Нарушение правил или обман\nПричина: Чужие фото\nКомментарий: Фото совпадают с внешним источником, у продавца нет подтверждений.", null, 6, "ADM-001", "Жалоба подтверждена, карточка снята с публикации"],
      ["CMP-010", "NEW", "other", "LST-016", "SLR-002", "BUY-003", "Категория: Общение с продавцом\nПричина: Невозможно связаться\nКомментарий: На вопросы по объявлению ответы не поступают.", null, null, null, null],
      ["CMP-011", "REJECTED", "other", "LST-003", "SLR-002", "BUY-001", "Категория: Общение с продавцом\nПричина: Невозможно связаться\nКомментарий: Жалоба продублирована, по первому обращению ответ уже дан.", null, 10, "ADM-001", "Отклонено как дубликат"],
      ["CMP-012", "PENDING", "suspicious_listing", "LST-013", "SLR-003", "BUY-004", "Категория: Информация в объявлении\nПричина: Неправдивые фото или описание\nКомментарий: Есть расхождения по комплектации.", null, null, null, null],
      ["CMP-013", "APPROVED", "fraud", "LST-020", "SLR-002", "BUY-002", "Категория: Нарушение правил или обман\nПричина: Кажется, это мошенники\nКомментарий: Есть признаки фиктивного объявления и противоречия в описании.", null, 3, "ADM-001", "Подтверждено подозрительное поведение"],
      ["CMP-014", "NEW", "suspicious_listing", "LST-025", "SLR-003", "BUY-003", "Категория: Информация в объявлении\nПричина: Неправдивые фото или описание\nКомментарий: Обнаружены незаявленные дефекты.", null, null, null, null],
      ["CMP-015", "PENDING", "other", "LST-022", "SLR-004", "BUY-001", "Категория: Общение с продавцом\nПричина: Хамство, грубость\nКомментарий: Продавец отвечает агрессивно и с оскорблениями.", null, null, null, null],
      ["CMP-016", "NEW", "suspicious_listing", "LST-019", "SLR-001", "BUY-004", "Категория: Информация в объявлении\nПричина: Неверный адрес\nКомментарий: Адрес из объявления не подтверждается.", null, null, null, null],
      ["CMP-017", "APPROVED", "fraud", "LST-026", "SLR-004", "BUY-003", "Категория: Нарушение правил или обман\nПричина: Чужие фото\nКомментарий: Фото товара не принадлежат продавцу.", null, 1, "ADM-001", "Жалоба подтверждена, объявление ограничено"],
      ["CMP-018", "PENDING", "other", "LST-021", "SLR-003", "BUY-002", "Категория: Общение с продавцом\nПричина: Хамил в ответах на вопросы\nКомментарий: Есть жалобы на грубые ответы.", null, null, null, null],
      ["CMP-019", "NEW", "fraud", "LST-026", "SLR-004", "BUY-001", "Категория: Нарушение правил или обман\nПричина: Чужие фото\nКомментарий: Визуалы полностью совпадают с другим объявлением.", null, null, null, null],
      ["CMP-020", "REJECTED", "suspicious_listing", "LST-010", "SLR-002", "BUY-004", "Категория: Информация в объявлении\nПричина: Неверная цена\nКомментарий: Ошибка не подтвердилась при проверке.", null, 7, "ADM-001", "Нарушение не подтверждено"],
      ["CMP-021", "NEW", "other", "LST-027", "SLR-001", "BUY-002", "Категория: Общение с продавцом\nПричина: Невозможно связаться\nКомментарий: Нет ответа более суток.", null, null, null, null],
      ["CMP-022", "PENDING", "suspicious_listing", "LST-028", "SLR-002", "BUY-003", "Категория: Информация в объявлении\nПричина: Неправдивые фото или описание\nКомментарий: Есть расхождения по состоянию товара.", null, null, null, null],
      ["CMP-023", "NEW", "suspicious_listing", "LST-029", "SLR-003", "BUY-004", "Категория: Информация в объявлении\nПричина: Объявление должно быть в другой категории\nКомментарий: Размещение в категории некорректно.", null, null, null, null],
      ["CMP-024", "PENDING", "fraud", "LST-030", "SLR-004", "BUY-001", "Категория: Нарушение правил или обман\nПричина: Кажется, это мошенники\nКомментарий: Продавец уклоняется от проверки и меняет условия сделки.", null, null, null, null],
      ["CMP-025", "NEW", "fraud", "LST-026", "SLR-004", "BUY-001", "Категория: Нарушение правил или обман\nПричина: Кажется, это мошенники\nКомментарий: Настаивает на срочной сделке, избегая стандартных шагов.", null, null, null, null],
      ["CMP-026", "PENDING", "other", "LST-026", "SLR-004", "BUY-004", "Категория: Общение с продавцом\nПричина: Невозможно связаться\nКомментарий: После публикации вопроса ответа в карточке нет длительное время.", null, null, null, null],
      ["CMP-027", "NEW", "suspicious_listing", "LST-026", "SLR-004", "BUY-003", "Категория: Информация в объявлении\nПричина: Неправдивые фото или описание\nКомментарий: Фото не соответствуют текущему состоянию лота.", null, null, null, null],
      ["CMP-028", "REJECTED", "other", "LST-026", "SLR-004", "BUY-002", "Категория: Общение с продавцом\nПричина: Невозможно связаться\nКомментарий: Повторное обращение без новых фактов.", null, 9, "ADM-001", "Закрыто как дубликат"],
      ["CMP-029", "PENDING", "suspicious_listing", "LST-026", "SLR-004", "BUY-001", "Категория: Информация в объявлении\nПричина: Неверная цена\nКомментарий: В заголовке и характеристиках объявления указаны разные цены.", null, null, null, null],
      ["CMP-030", "NEW", "other", "LST-026", "SLR-004", "BUY-004", "Категория: Общение с продавцом\nПричина: Хамство, грубость\nКомментарий: Получены оскорбительные сообщения.", null, null, null, null],
      ["CMP-031", "APPROVED", "fraud", "LST-026", "SLR-004", "BUY-003", "Категория: Нарушение правил или обман\nПричина: Чужие фото\nКомментарий: Подтверждено использование чужих материалов.", null, 2, "ADM-001", "Жалоба подтверждена, приняты меры"],
      ["CMP-032", "PENDING", "other", "LST-026", "SLR-004", "BUY-002", "Категория: Общение с продавцом\nПричина: Хамил в ответах на вопросы\nКомментарий: Некорректное поведение повторяется.", null, null, null, null],
    ].map((c: any) => ({
      public_id: c[0],
      status: "NEW",
      complaint_type: c[2],
  ...
  await prisma.auditLog.createMany({
    data: [
      ["AUD-001", "complaint.status_changed", "complaint", "CMP-001", { доСтатуса: "NEW", послеСтатуса: "APPROVED" }, 4],
