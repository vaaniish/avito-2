...
async function main(): Promise<void> {
  ...
  const listingsSeed: ListingSeed[] = [
    ...
    },
    {
      ...
      category_name: "Беззеркальные камеры",
      price: 204900,
      sale_price: 194900,
      rating: 4.9,
      condition: "NEW",
    ...
    },
    {
      ...
      category_name: "Сценарии автоматизации",
      price: 12000,
      sale_price: null,
      rating: 4.5,
      condition: "NEW",
    ...
    },
    {
      ...
      category_name: "Ремонт после воды",
      price: 1500,
      sale_price: null,
      rating: 1.9,
      condition: "NEW",
