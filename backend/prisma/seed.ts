...
async function main(): Promise<void> {
  ...
  const partnershipRequests = [
    {
      ...
      credibility: "Собирают документы для полного онбординга",
      whyUs: "Хотят протестировать безопасную сделку до массового запуска",
      reviewedBy: null,
    ...
    },
    {
      ...
      geography: "Москва",
      socialProfile: "@north",
      credibility: "Работают с 2018 года, есть сайт и карточки на маркетплейсах",
      whyUs: "Нужны безопасные сделки и стабильный поток качественного трафика",
      reviewedBy: null,
      reviewedDaysAgo: null,
      rejectionReason: null,
      adminNote: null,
    },
    {
      ...
      whyUs: "Нужны новые каналы продаж и защита в спорных сделках",
      reviewedBy: "ADM-001",
      reviewedDaysAgo: 7,
      rejectionReason: null,
      adminNote: "Проверка юридических данных и домена в процессе.",
    },
    {
      publicId: "PRQ-004",
      ...
      credibility: "Локальный бренд восстановленной техники",
      whyUs: "Планирую масштабировать продажи и усилить доверие покупателей",
      reviewedBy: "ADM-001",
      reviewedDaysAgo: 6,
      rejectionReason: null,
      adminNote: "Нужно подтвердить полномочия представителя бренда.",
    },
    {
      publicId: "PRQ-005",
      ...
      category: "Установка и сервис",
      inn: "2302000004",
      geography: "Сочи",
      socialProfile: "@seabreeze",
      credibility: "Сертифицированные мастера и собственный склад",
      whyUs: "Нужна защита в спорных ситуациях и повышение конверсии",
      reviewedBy: "ADM-001",
      reviewedDaysAgo: 5,
      rejectionReason: null,
      adminNote: "Ожидаем финальное подтверждение реквизитов для выплат.",
    },
    {
      publicId: "PRQ-006",
      ...
      credibility: "Сильный сервис, но нужно подтвердить стандарты диагностики",
      whyUs: "Хотят продавать устройства с гарантией и грейдингом",
      reviewedBy: "ADM-001",
      reviewedDaysAgo: 4,
      rejectionReason: null,
      adminNote: "Команда качества проверяет процесс диагностики и серийный контроль.",
    },
    {
      publicId: "PRQ-007",
      ...
      credibility: "Есть подтвержденная операционка, но payout ещё под наблюдением",
      whyUs: "Хочу развивать продажи в нескольких городах с лимитом на старте",
      reviewedBy: "ADM-001",
      reviewedDaysAgo: 3,
      rejectionReason: null,
    ...
    },
    {
      ...
      credibility: "Данных о происхождении товара пока недостаточно",
      whyUs: "Нужны продажи, но документы на поставщиков еще собираются",
      reviewedBy: "ADM-001",
      reviewedDaysAgo: 2,
      rejectionReason: "Нужны документы на поставщиков и подтверждение домена.",
      adminNote: "Запросили дополнительные материалы по происхождению товара.",
    },
    {
      publicId: "PRQ-009",
      ...
      credibility: "Есть подтвержденный домен, офис и склад",
      whyUs: "Нужна зрелая партнерская витрина и расширение ассортимента",
      reviewedBy: "ADM-001",
      reviewedDaysAgo: 1,
      rejectionReason: null,
      adminNote: "Полное одобрение после прохождения payout и quality review.",
    },
    {
      publicId: "PRQ-010",
      userPublicId: "BUY-004",
      ...
      credibility: "Есть внешние отзывы, но нет подтверждения происхождения товара",
      whyUs: "Нужна аналитика и рост продаж",
      reviewedBy: "ADM-001",
      reviewedDaysAgo: 1,
      rejectionReason: "Не удалось подтвердить законность происхождения части ассортимента.",
      adminNote: "Повторная подача возможна после обновления пакета документов.",
    },
    {
      publicId: "PRQ-011",
      userPublicId: "BUY-006",
      ...
      credibility: "Готова логистика и сервисный процесс, идет финальная очередь проверки",
      whyUs: "Нужен понятный канал продаж с безопасной сделкой",
      reviewedBy: "ADM-001",
      reviewedDaysAgo: 1,
      rejectionReason: null,
  ...
  function onboardingProfileDraft(params: {
    ...
    return {
      ...
      business_role: "Розничная и сервисная продажа техники",
      ...
      service_hours: "Пн-Пт 09:00-19:00",
      monthly_capacity:
        params.recommendationMode === "strong"
          ...
          : params.recommendationMode === "limited"
            ? 120
            : 80,
      product_source_type: "Официальные поставщики и выкуп trade-in",
      supplier_documents:
        params.recommendationMode === "needs_docs"
          ? "Нужны дополнительные договоры с поставщиками"
          : "Договоры поставки, акты выкупа, счета-фактуры",
  ...
  await prisma.partnerOnboardingProfile.createMany({
    data: [
      ...
      onboardingProfileDraft({
        ...
        categories: ["electronics_repair", "accessories"],
        listingLimit: 35,
        payoutVerified: false,
      ...
      onboardingProfileDraft({
        ...
        inn: "166400000003",
        ogrn: "1181690003210",
        legalName: "Irina Home Lab",
        city: "Казань",
        region: "Республика Татарстан",
        categories: ["home_appliances", "kitchen_appliances"],
        listingLimit: 40,
        payoutVerified: false,
        recommendationMode: "limited",
      }),
      onboardingProfileDraft({
        ...
        categories: ["home_appliance_repair", "electronics_repair"],
        listingLimit: 45,
        payoutVerified: false,
        recommendationMode: "limited",
      }),
      onboardingProfileDraft({
        ...
        city: "Москва",
        region: "Москва",
        categories: ["smartphones", "audio", "wearables"],
        listingLimit: 50,
        payoutVerified: false,
        recommendationMode: "needs_docs",
      }),
      onboardingProfileDraft({
        ...
        city: "Краснодар",
        region: "Краснодарский край",
        categories: ["electronics_repair", "home_appliance_repair"],
        listingLimit: 20,
        payoutVerified: false,
        recommendationMode: "limited",
      }),
      ...
      onboardingProfileDraft({
        ...
        city: "Новосибирск",
        region: "Новосибирская область",
        categories: ["smartphones", "wearables", "accessories"],
        listingLimit: 45,
        payoutVerified: false,
        recommendationMode: "limited",
      }),
